                ...
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="<?php echo site_url('Auditor/Chapters') ?>">Chapters</a></li>
                            <li><a href="<?php echo site_url('Auditor/Subjects') ?>">Subjects</a></li>
                            <li><a href="<?php echo site_url('Auditor/Questions') ?>">Questions</a></li>
                            <li><a href="<?php echo site_url('Auditor/Responses') ?>">Responses</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="<?php echo site_url('Auditor/doc_by_department') ?>">Documents by department</a></li>
                            <li><a href="<?php echo site_url('Auditor/List_Requests') ?>">List of Requests</a></li>
                            <li><a href="<?php echo site_url('Auditor/Document_Status') ?>">Documents Status</a></li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="<?php echo site_url('Auditor/Department') ?>">Department</a></li>
                            <li><a href="<?php echo site_url('Auditor/Employee') ?>">Employee</a></li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li><a href="<?php echo site_url('Auditor/type_action') ?>">Action Types</a></li>
                            <li><a href="<?php echo site_url('Auditor/Action') ?>">Actions</a></li>
                            <li><a href="<?php echo site_url('Auditor/Risk') ?>">Risks</a></li>
