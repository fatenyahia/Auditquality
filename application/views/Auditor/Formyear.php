            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <div class="header">
                            <div class="header-left">
                                <a href="<?php echo base_url() ?>/Auditor" class="logo">
                    ...
                    <a class="dropdown-item" href="settings.html">Settings</a-->
                        ...
                        <li>
                            <a href="<?php echo site_url('Auditor/Department') ?>"><i class="fa fa-user-md"></i> <span>Departments</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Auditor/Chapters') ?>"><i class="fa fa-user-md"></i> <span>Chapters</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Auditor/Subjects') ?>"><i class="fa fa-user-md"></i> <span>Subjects</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Auditor/Questions') ?>"><i class="fa fa-user-md"></i> <span>Questions</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Auditor/Responses') ?>"><i class="fa fa-user-md"></i> <span>Responses</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('Auditor/Year') ?>"><i class="fa fa-user-md"></i> <span>Audit Year</span></a>
                        </li>
                        <!--li class="submenu">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <form action="<?= base_url() ?>/Auditor/edit_year" method="post">
