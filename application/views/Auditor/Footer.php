    ...
    <script src="<?php echo base_url() . "/includes/ext/"; ?>assets/template/js/jquery.slimscroll.js"></script>
    <script src="<?php echo base_url() . "/includes/ext/"; ?>assets/template/js/Chart.bundle.js"></script>
    <script src="<?php echo base_url() . "/includes/ext/"; ?>assets/template/js/chart.js"></script>
