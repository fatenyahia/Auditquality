		...
		<div class="sidebar-menu sticky-sidebar-menu">
			...
			<div class="sidebar-menu-inner">
				...
				<ul class="nav nav-pills nav-stacked custom-nav">
					<li class="active"><a href="<?php echo site_url('Auditor/Chapters') ?>"><i class='fas fa-book' style='font-size:24px'></i><span> Chapters</span></a>
					</li>
					<!--li class="menu-list">
            ...
            <li><a href="people.html">People cards</a></li>
					...
					<li class="active"><a href="<?php echo site_url('Auditor/Subjects') ?>"><i style='font-size:24px' class='far'>&#xf02e;</i><span> Subjects</span></a>
					</li>
					<li><a href="<?php echo site_url('Auditor/Questions') ?>"><i style='font-size:24px' class='fas'>&#xf059;</i> <span>Questions</span></a></li>
					<li><a href="<?php echo site_url('Auditor/Responses') ?>"><i style='font-size:24px' class='far'>&#xf4ad;</i><span>Responses</span></a></li>
					<li><a href="<?php echo site_url('Auditor/Department') ?>"><i style='font-size:24px' class='far'>&#xf1ad;</i><span>Departments</span></a></li>
					<li><a href="<?php echo site_url('Auditor/Year') ?>"><i style='font-size:24px' class='far'>&#xf073;</i> <span>Audit Year</span></a></li>
