                    ...
                    <div class="table-responsive">
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <form action="<?php echo base_url(); ?>Technical_Account/List_employees_skill?ID_skill=<?php echo $ID_skill ?>" enctype="multipart/form-data" method="post">
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <?php if ($row['ID_training_group'] == null) { ?>
                                                                    ...
                                                                    <a href="<?php echo base_url(); ?>Technical_Account/Add_training_group_employee?ID_skill_employee=<?php echo  $row['ID_skill_employee'] ?>&ID_skill=<?php echo  $ID_skill ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i></a>
                                                ...
                                                ?>
                                                        <li>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <a href="<?php echo base_url() ?>/Technical_Account/Delete_training_group?ID_training_group=<?php echo $row['ID_training_group'] ?>&ID_skill=<?php echo $ID_skill ?>">
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="card-box">
                                                    <form id="popup" action="<?php echo base_url(); ?>Technical_Account/Submit_add_training_group/" enctype="multipart/form-data" method="post">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="card-box">
                                                    <form id="popup1" action="<?php echo base_url(); ?>Technical_Account/Submit_add_training_group_employee" enctype="multipart/form-data" method="post">
                                                        <div class="row">
                                                            <input type="hidden" name="ID_skill" value="<?php echo $ID_skill ?>">
