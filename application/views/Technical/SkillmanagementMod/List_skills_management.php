                    ...
                    <div class="card member-panel" style="height: 89%;">
                        <div class="card-header bg-white">
                            ...
                            <div class="row">
                                ...
                                <?php }else { ?>
                                <div class="col-md-8">
                                    <a class="btn btn-primary btn-rounded float-right" href="<?php echo base_url(); ?>Technical_Account/Form_add_skill_management?ID_post=<?php echo $ID_post ?>" ><i class="fa fa-plus"></i> Add Skill</a>
                                </div>
                                <?php } ?>
                            </div>
                        </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="contact-cont">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <a href="<?php echo base_url(); ?>Technical_Account/Form_edit_skill_management?ID_management=<?php echo $row['ID_management'] ?>">
                                                            <button class="btn btn-primary btn-primary-three float-right">Update</button>
                                                        </a>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <form id="popup" action="Technical_Account/Delete_skill_management?ID_management=<?php echo $row['ID_management'] ?>" enctype="multipart/form-data" method="get">
