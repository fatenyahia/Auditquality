                ...
                <section class="forms">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    <form action="<?php echo base_url(); ?>Technical_Account/Submit_add_function/" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <?php if (isset($ID_function)) {
                                                        ?>
                                                            <input type="hidden" name="ID_function" value="<?php echo $ID_function ?>">
                                                        <?php } ?>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select class="form-control" name="ID_department" id="ID_function">
                                                            <?php
