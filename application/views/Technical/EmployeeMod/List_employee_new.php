        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Technical_Account/Form_add_employee_new') ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Employee</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                            ...
                                                            <td class="text-right">
                                                                <div class="dropdown dropdown-action">
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-right">
                                                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Technical_Account/view_employee_new?ID_employee=<?php echo $row['ID_employee'] ?>"><i class="fa fa-pencil m-r-5"></i> View</a>
                                                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Technical_Account/Add_department_position?ID_employee=<?php echo $row['ID_employee'] ?>"><i class="fa fa-pencil m-r-5"></i> Department & position</a>
                                                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Technical_Account/Form_edit_employee_new?ID_employee=<?php echo $row['ID_employee'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                                        <a class="dropdown-item" href="<?php echo base_url(); ?>Technical_Account/Delete_employee_new?ID_employee=<?php echo $row['ID_employee'] ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td>
