                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-box">
                                    ...
                                    <form action="<?php echo base_url(); ?>Technical_Account/Add_position_department/" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        /*      if (isset($position)) {
                                                            ...
                                                            foreach ($position as $row) {
                                                                $i = $i + 1;
                                                                Array_push($phpArray, $row['ID_department']);
                                                                Array_push($phpArrayname, $row['Name_department']);
                                                            }
                                                        }
                                                        echo print_r($phpArray);
                                                       */ ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary">Choose Position</button>
                                        </div>
                                    </form>
