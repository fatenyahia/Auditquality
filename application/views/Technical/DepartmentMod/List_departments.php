        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Technical_Account/Form_add_department') ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add department</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                                    ...
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="text-right">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <a href="<?php echo base_url(); ?>Technical_Account/view_department?ID_department=<?php echo $row['ID_department'] ?>">
                                                                        <button class="btn btn-primary btn-primary-three float-right"><i class="fa fa-search m-r-5"></i>View</button>
                                                                    </a>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <form action="<?php echo base_url(); ?>Technical_Account/View_Delete_department?ID_department=<?php echo $row['ID_department'] ?>" enctype="multipart/form-data" method="post">
                                                        ...
                                                        <!--td class="text-right">
                                                            <div class="dropdown dropdown-action">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Technical_Account/List_departments_post?ID_department=<?php echo $row['ID_department'] ?>"><i class="fa fa-map-o m-r-5"></i> Positions</a>
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Technical_Account/List_departments_employee?ID_department=<?php echo $row['ID_department'] ?>"><i class="fa fa-user-o m-r-5"></i> Employees</a>
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Technical_Account/view_department?ID_department=<?php echo $row['ID_department'] ?>"><i class="fa fa-search m-r-5"></i> View</a>
                                                                    <a class="dropdown-item" href="<?php echo base_url(); ?>Technical_Account/Form_edit_department?ID_department=<?php echo $row['ID_department'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                                    <form id="popup" action="<?php echo base_url(); ?>Technical_Account/Delete_department?ID_department=<?php echo $row['ID_department'] ?>" enctype="multipart/form-data" method="post">
