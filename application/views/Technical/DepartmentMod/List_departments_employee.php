        ...
        <div class="content">
            <div class="row">
                ...
                <div class="col-sm-8 col-9 text-right m-b-20">
                    <a href="<?php echo site_url('Technical_Account/Form_add_department_employee?ID_department_post=' . $ID_department_post . '') ?>" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Employee</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                                            ...
                                            ?>
                                                    ...
                                                    ?>
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="text-right">
                                                                <a href="<?php echo base_url(); ?>Technical_Account/List_skills_employee?ID_employee=<?php echo $row['ID_employee'] ?>" class="btn btn-outline-primary take-btn">Details</a>
                                                            </td>
                                                            <input type="hidden" name="ID_department_post" value="<?php echo $row['ID_department_post'] ?>" > 

                                                            <td>
                                                            <a href="<?php echo base_url(); ?>Technical_Account/Form_edit_department_employee?ID_employee=<?php echo $row['ID_employee'] ?>">
                                                                        <button class="btn btn-primary btn-primary-three float-right"><i class="fa fa-pencil m-r-5"></i>Update</button>
                                                                    </a>
                                                            </td>
                                                            <td class="text-right">

                                                                <form id="popup" action="<?php echo base_url(); ?>Technical_Account/Delete_department_employee?ID_employee=<?php echo $row['ID_employee'] ?>" enctype="multipart/form-data" method="post">
                                                                    <input type="hidden" name="ID_department_post" value="<?php echo $row['ID_department_post'] ?>" > 
