<?php
class Mdepartmentemployee extends CI_Model
{
    ...
    function add_department_employee($data)
    {
    ...
    function get_department_employee_by_ID($ID_employee)
    {
        $this->db->select('*');
        $this->db->from('auditquality_employee');
        $this->db->join('auditquality_department_post', 'auditquality_department_post.ID_department_post = auditquality_employee.ID_employee');
    ...
    function get_employees_by_departmentemployee($ID_employee)
    {
        $this->db->select('*');
        $this->db->from('auditquality_employee');
        $this->db->join('auditquality_department_post', 'auditquality_department_post.ID_department_post = auditquality_employee.ID_department_post');
    ...
    function edit_department_employee($data, $ID_employee)
    {
             $this->db->where('auditquality_employee.ID_employee', $ID_employee);
    ...
    function delete_department_employee($ID_employee)
    {
    ...
    function get_departments_employee_paging($page,$ID_department_post)
    {
        $this->db->select('*');
        $this->db->from('auditquality_employee');
        $this->db->join('auditquality_department_post', 'auditquality_department_post.ID_department_post = auditquality_employee.ID_department_post');
    ...
    function get_departments_employee_nb_page($ID_department_post)
    {
