...
/*****************************************new */
    ...
    function get_chapters_by_department($id)
    {
        $this->db->select('*');
        $this->db->from('auditquality_chapters');
        $this->db->join('auditquality_access', 'auditquality_access.ID_chapter = auditquality_chapters.ID_chapter');
        //$this->db->group_by('auditquality_access.ID_chapter');
        $this->db->where('auditquality_access.ID_department=' . $id);
        $query = $this->db->get();
        return $query->result_array();
    }
    function get_questions_by_department($id,$id_dept)
    {
        $this->db->select('*');
        $this->db->from('auditquality_questions');
        ...
        $this->db->order_by('ID_question');
        $this->db->where('auditquality_questions.ID_chapter=' . $id);
        $this->db->where('auditquality_access.ID_department=' . $id_dept);
        $query = $this->db->get();
        // echo print_r($query->result_array()) ;die();
        return $query->result_array();
    }
