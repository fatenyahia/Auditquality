...
class Technical extends CI_Controller
{
	...
	public function _example_output($output = null)
	{
		...
		$this->load->view('Technical/Index.php', (array) $output);
	}
	...
	public function Document()
	{
		...
		if (isset($_POST['create'])) {
			//$reate_request_doc=1;
			redirect(base_url() . 'Technical/create_request_from_document');
			$crud->callback_after_insert(array($this, 'create_request_from_document'));

			//	$crud->add_action('Create Request', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Technical/Create_request/', '');
			//	$create = 1;
			//	echo $create;	die();
			//	$crud->unset_add();
		...
		if (isset($_POST['update'])) {
			$crud->add_action('Update Request', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Technical/Update_request/', '');
			//	$update=2;
			//	echo $update ; die();
		}
		if (isset($_POST['delete'])) {
			$crud->add_action('Delete Request', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/close.png', 'Technical/Delete_request', '');

			//	$delete=3;
			//	echo $delete ; die();
		}
		//$crud->add_action('All Request', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/clone.png', 'Technical/All_request/', '');
	...
	function doc_by_department()
	{
		...
		$crud->add_action('Show documents', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Technical/Show_documents', '');
	...
	function Delete_request($ID_document)
	{
		...
		$this->load->view('Technical/Delete_request.php');
	}
	...
	function Update_request($ID_document)
	{
		...
		//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		//redirect(base_url() . 'Technical/Update_request/'.$ID_document.'/add');
	}
	...
	function List_Requests()
	{
		...
		$crud->add_action('Accept', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/accept.png', 'Technical/Accept_request/', '');
		$crud->add_action('Refuse', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/refuse.png', 'Technical/Refuse_request/', '');
	...
	function Accept_request($ID_requests)
	{
		...
		redirect(base_url() . 'Technical/List_Requests');
	}
	...
	public function Document_Status()
	{
		...
		$this->load->view('Technical/Requests_status');
	}
	public function Document_Status_update()
	{
		...
		if (isset($_POST['create'])) {
			...
			$crud->add_action('Update', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Technical/Add_Document', '');
		...
		if (isset($_POST['update'])) {
			...
			$crud->where('Validatedby_requests!=' . 0);
			$crud->where('Validatedby_requests!=' . -1);
			$crud->add_action('Update', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Technical/Update_Document', '');
			$crud->set_subject('auditquality_doc_requests');
		}
		if (isset($_POST['delete'])) {
			...
			$crud->where('Validatedby_requests!=' . 0);
			$crud->where('Validatedby_requests!=' . -1);
			$crud->add_action('Update', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Technical/Deleted_Document', '');
			$crud->set_subject('auditquality_doc_requests');
		}
	...
	function Update_Document($ID_request)
	{
		...
		//die();
		$this->load->view('Technical/Update_Document', $data);
	}
	...
	function Add_Document($ID_request)
	{
		...
		$this->load->view('Technical/Add_Document', $data);
	}
	...
	function Add_Document_action($ID_request)
	{
		...
		if (($Validatedby_requests != 0) || ($Validatedby_requests != -1)) {
			return site_url('Technical/Add_Document', $data);
		} else {
			return site_url('');
		}
	}
	...
	function submit_update_doc()
	{
		...
		return redirect(base_url() . 'Technical/Document_Status');
	}
	...
	function Document_validation()
	{
		...
		$crud->add_action('Accept', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/accept.png', 'Technical/Accept_document/', '');
		$crud->add_action('Refuse', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/refuse.png', 'Technical/Refuse_document/', '');
	...
	function Accept_document($ID_version)
	{
		...
		redirect(base_url() . 'Technical/Document_validation');
	}
	...
	function Requests()
	{
		$this->load->view('Technical/Requests');
	}
	...
	function Intern_audit()
	{
		...
		//$crud->add_action('Audit Date', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Technical/Audit_date', '');
		$crud->add_action('Audit Actors', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Technical/Audit_actor', '');
		$crud->add_action('Non conformities', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Technical/Audit_non_conformities', '');
	...
	public function Posts()
	{
		...
		//	$crud->add_action('Add Skill', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/skill.png', 'Technical/add_Skill', '');
	...
	public function Skill_for_post($post_array)
	{
		...
		//return redirect(base_url() . 'Technical/Access/' . $ID_department);
	}
	...
	function add_Position_to_department($ID_department)
	{
		...
		$crud->set_relation('ID_department', 'auditquality_department', '{Name_department}');
		$crud->set_relation('ID_post', 'auditquality_posts', '{Name_post}');
		$crud->add_action('New Employee', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Technical/Add_employee_to_position/', '');
	...
	function Add_employee_to_position($ID_department_post)
	{
		$this->commonData();
		$ID_company = 1;
		$crud = new grocery_CRUD();
		$this->ID_post_for_emp = $ID_department_post;
		$crud->set_table('auditquality_employee');
		$crud->columns('Name_employee', 'Lastname_employee', 'Phone_employee', 'Email_employee', 'ID_access_group');
		$crud->set_relation('ID_access_group', 'auditquality_access_group', '{Name_access_group}');
		$crud->add_action('Skills', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Technical/Skill_employee', '');
		$crud->display_as('Name_employee', 'Employee Name')
			...
			->display_as('ID_access_group', 'Group Access');

		$crud->set_subject('auditquality_employee');
		$crud->unset_fields('ID_department_post');
		$crud->where('ID_department_post', $this->ID_post_for_emp);
		$crud->unset_clone();
		$crud->callback_after_insert(array($this, 'Encrypt_password'));
		$crud->callback_after_insert(array($this, 'Affect_position_to_employee'));
	...
	public function Affect_position_to_employee($post_array, $ID_employee)
	{
		$this->commonData();
		$this->Mcompany->edit_department_position_for_employee($this->ID_post_for_emp, $ID_employee);
	}
	...
	function department(/*$ID_company*/)
	{
		...
		$crud->set_table('auditquality_department');
		//$crud->required_fields('Titre');
		$crud->columns('Name_department', 'Director_department');
		$crud->set_relation('Parent_department', 'auditquality_department', '{Name_department}');
		$crud->set_relation('Director_department', 'auditquality_employee', '{Name_employee}');

		//$crud->add_action('Access Management', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Technical/Access', '');
		$crud->add_action('New Position', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/skill.png', 'Technical/add_Position_to_department', '');
		$crud->add_action('Employees', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/skill.png', 'Technical/Employees', '');
		$crud->add_action('Director', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/director.png', 'Technical/Director', '');

		//$crud->set_relation('', 'auditquality_company', '{} {}');
		$crud->display_as('Name_department', 'Department Name')
			->display_as('Director_department', 'Director');
		$crud->set_subject('auditquality_department');
		$crud->unset_fields('ID_company');
		$this->ID_company = $ID_company;
		//$this->ID_department = $ID_department;

		$crud->where('auditquality_department.ID_company', $ID_company);
		$crud->unset_clone();
		$crud->callback_after_insert(array($this, 'Combined_function'));
	...
	function Director($ID_department)
	{
		...
		$this->load->view('Technical/Affect_director', $data);
	}
	...
	function submit_affect_director()
	{
		if ($_POST) {
			...
			return redirect(base_url() . 'Technical/Department/');
		}
	}
	...
	function Employees($ID_department)
	{
		...
		$ID_company = 1;
		$crud = new grocery_CRUD();
		$this->ID_department_for_employee = $ID_department;
		$this->Mcompany->Get_department_post_by_department($this->ID_department_for_employee);


		$crud->set_table('auditquality_employee');
		$crud->columns('Name_employee', 'Lastname_employee', 'Phone_employee', 'Email_employee', 'ID_department_post', 'ID_access_group');
		$crud->set_relation('ID_access_group', 'auditquality_access_group', '{Name_access_group}');
		//$crud->set_relation('ID_access_group', 'auditquality_posts', '{Name_post}', 'auditquality_posts.ID_department=' . $ID_department);

		$crud->set_relation('ID_department_post', 'auditquality_department_post', '{ID_post}', 'auditquality_department_post.ID_department=' . $this->ID_department_for_employee);
		//$crud->set_relation('ID_post', 'auditquality_posts', '{Name_post}');
		...
		$crud->display_as('Name_employee', 'Employee Name')
			...
			->display_as('Phone_employee', 'Phone')
			->display_as('Email_employee', 'Email')
			->display_as('ID_department_post', 'Position')
			->display_as('ID_access_group', 'Group Access');

		$crud->set_subject('auditquality_employee');
		//$crud->unset_fields('ID_department_post');
		//$this->ID_company = $ID_company;
		//$crud->where('auditquality_posts.ID_post == auditquality_department_post.ID_post');

		/*********************************************problem here ******************************/


		/********************* Position by department *******************************/
		$list_posts = $this->Mcompany->Get_department_post_by_department($this->ID_department_for_employee);

		/****************************************************************************/
		//echo print_r($list_posts); die();
		if ($list_posts == Null) {
			$crud->where('auditquality_employee.ID_department_post', 0);
		} else {
			foreach ($list_posts as $row) {
				foreach ($row as $row2) {
					//echo print_r($row2)."--";
					$crud->or_where('auditquality_employee.ID_department_post', $row2);
				}
			}
		}
		//die();
		$crud->unset_clone();
		$crud->callback_after_insert(array($this, 'Encrypt_password'));
		//$crud->callback_after_insert(array($this, 'Affect_department_to_employee'));
	...
	/*function Affect_department_to_employee($post_array, $ID_employee)
	{
		$this->commonData();	
		$this->Mcompany->edit_department_for_employee($this->ID_department_for_employee, $ID_employee);
	}*/
	...
	function Employee()
	{
		...
		$crud->add_action('Department & Position', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Technical/Department_position', '');
	...
	public function Department_position($ID_employee)
	{
		...
		/*if ($_POST) {
			if ($_POST['ID_department']) {
				...
				$this->load->view('Technical/Department_position', $data);
			} else {
				if ($_POST['newID_department']) {
					...
					return redirect(base_url() . 'Technical/submit_department_position/?ID_department=' . $data['newID_department'] . '&ID_post=' . $data['newID_post'] . '$ID_director=' . $data['ID_employee']);
				}
			}
		} else {
			$this->load->view('Technical/Department_position', $data);
	...
	public function Position_department()
	{
		...
		$this->load->view('Technical/Position_department', $data);
	}
	...
	function submit_department_position()
	{
		...
		return redirect(base_url() . 'Technical/Employee');
	}
	/***********************************************************************************/
	/***********************************************************************************/

	public function Encrypt_password($post_array, $ID_employee)
	{
		$this->commonData();

		$this->data['pwd'] = $this->Mcompany->get_password_employee($ID_employee);
		$Password_employee = $this->data['pwd'][0]['Password_employee'];
		$newpwd = md5($Password_employee);
		$this->Mcompany->edit_password_encrypt_employee($newpwd, $ID_employee);
	}
	...
	public function Risk()
	{
		...
		$crud->set_relation('ID_department', 'auditquality_department', '{Name_department}');
		$crud->set_relation('ID_type', 'auditquality_type', '{Title_type}');
		$crud->add_action('Actions for Risk', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/form.png', 'Technical/Action_risk', '');
	...
	function Access_group()
	{
		...
		$crud->set_table('auditquality_access_group');

		$crud->columns('ID_access_group', 'Name_access_group', 'ID_company');
		$crud->set_relation('ID_company', 'auditquality_company', '{Name_company}');
		//$crud->set_relation('ID_employee', 'auditquality_employee', '{Name_employee}');

		$crud->display_as('Name_access_group', 'Access Group Name')
			->display_as('ID_company', 'Name Company');

		$crud->set_subject('auditquality_access_group');
		$crud->unset_clone();
		$output = $crud->render();
	...
	function Functions()
	{
		...
		$crud->set_table('auditquality_functions');

		$crud->columns('Name_function', 'URL_function');

		$crud->display_as('Name_function', 'Function')
			->display_as('URL_function', 'URL');

		$crud->set_subject('auditquality_functions');
		$crud->unset_clone();
		$output = $crud->render();
	...
	public function Functions_access()
	{
		$this->commonData();
		$ID_company = 1;
		//$data['ID_employee'] = $ID_employee;
		$data['group'] = $this->Mcompany->Get_group_access();
		$data['function'] = $this->Mcompany->Get_functions();


		$this->load->view('Technical/Function_access', $data);
	}
	...
	function Function_access()
	{
		$this->commonData();
		$crud = new grocery_CRUD();
		$crud->set_table('auditquality_functions_access');
		$crud->columns('ID_access_group', 'ID_function', 'View_functions_access', 'Edit_functions_access');
		$crud->set_relation('ID_access_group', 'auditquality_access_group', '{Name_access_group}');
		$crud->set_relation('ID_function', 'auditquality_functions', '{Name_function}');

		$crud->display_as('View_functions_access', 'View')
			->display_as('Edit_functions_access', 'Edit')
			->display_as('ID_access_group', 'Group')
			->display_as('ID_function', 'URL');


		$crud->set_subject('auditquality_functions_access');
		$crud->unset_clone();
		$crud->unset_edit();
		$crud->unset_delete();
		$crud->unset_add();
	...
	function Submit_new_access()
	{

		$ID_access_group = $_POST['ID_access_group'];
		$ID_function = $_POST['ID_function'];
		$access_type = $_POST['access_type'];
		if ($_POST['access_type'] == 'view') {
			$View_functions_access = 1;
			$Edit_functions_access = 0;
		} elseif ($_POST['access_type'] == 'edit') {
			$View_functions_access = 0;
			$Edit_functions_access = 1;
		}


		$data =
			array(
				"ID_access_group" => $ID_access_group,
				"ID_function" => $ID_function,
				"View_functions_access" => $View_functions_access,
				"Edit_functions_access" => $Edit_functions_access,


			);
		$this->Mcompany->add_new_access($data);


		return redirect(base_url() . 'Technical/Function_access');
	}
}
