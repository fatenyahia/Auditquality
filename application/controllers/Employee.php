...
class Employee extends CI_Controller
{
	...
	public function commonData()
	{
		...
		$this->data['listaccess'] = $this->Mcompany->get_function_by_group($ID_access_group);
		...
		/*echo "<pre>";
		echo print_r($editarray);
		echo "<pre>";
		die();*/


		//echo "<pre>" ; echo print_r($this->data['listaccess']); echo "<pre>" ;
		//die();

		/****************** End Access Management *************************/
		/********************* Access Group *************************/
		$this->directoraccount = 0;
		$this->employeeaccount = 0;
		if ($this->session->userdata('ID_access_group') == 1) {
			$this->directoraccount = 1;
			$this->ID_current_director = $this->session->userdata('ID_employee');
			$this->ID_current_department_director = $this->Mcompany->get_deartment_by_director($this->ID_current_director);
			//echo $ID_director.'--' ;
			//echo print_r($ID_department_director) ; die();
		} else {
			$this->employeeaccount = 1;
			$this->ID_current_employee = $this->session->userdata('ID_employee');
			$this->ID_current_department_employee = $this->Mcompany->get_deartment_by_employee($this->ID_current_employee);
			//echo ($this->ID_current_department_employee);
			//die();
		}
	...
	public function _example_output($output = null)
	{
		...
		$this->load->view('Employee/Index.php', (array) $output);
	}
	...
	public function Chapters()
	{
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			//echo "hi";
			//die();
			$this->load->view('Employee/No_access.php');
		} else {
			/***********************************************************************/
			...
			if ($test_verif_view == 0) {
				$crud->unset_read();
			}
			if ($test_verif_edit == 0) {
				$crud->unset_edit();
				$crud->unset_add();
				$crud->unset_delete();
			}
			/********************************* End Apply Access Control *************************************/
	...
	public function Document()
	{
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			if ($this->employeeaccount == 1) {
				//echo 'hi';
				$crud->set_relation('ID_document', 'auditquality_document', '{Title_document}', 'ID_department=' .  $this->ID_current_department_employee);
			} else {
			...
			if (isset($_POST['create'])) {
				//$reate_request_doc=1;
				redirect(base_url() . 'Employee/create_request_from_document');
				$crud->callback_after_insert(array($this, 'create_request_from_document'));

				//	$crud->add_action('Create Request', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Employee/Create_request/', '');
				//	$create = 1;
				//	echo $create;	die();
				//	$crud->unset_add();
			...
			if (isset($_POST['update'])) {
				$crud->add_action('Update Request', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Employee/Update_request/', '');
				//	$update=2;
				//	echo $update ; die();
			}
			if (isset($_POST['delete'])) {
				$crud->add_action('Delete Request', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/close.png', 'Employee/Delete_request', '');

				//	$delete=3;
				//	echo $delete ; die();
			}
			//$crud->add_action('All Request', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/clone.png', 'Employee/All_request/', '');
	...
	function doc_by_department()
	{
		...
		/******************************** Session Access Control **********************************/
		$test_verif_view = 0;
		$current_function = "doc_by_department";
		foreach ($this->viewarray as $row) {
			if ($row == $current_function) {
				$test_verif_view = 1;
				break;
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			$crud->add_action('Show documents', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Employee/Show_documents', '');
			...
			//$crud->where('auditquality_department.ID_department', 52);

			if ($this->directoraccount == 1) {
				$crud->where('auditquality_department.ID_department', 0);
				foreach ($this->ID_current_department_director as $row) {
					foreach ($row as $row1) {
						//echo $row1 ;
						$dept = intval($row1);
						//echo $dept; die();
						$crud->or_where('auditquality_department.ID_department', $dept);
					}
				}
				//die();
			} else {
				...
				if ($this->employeeaccount == 1) {
					$crud->where('auditquality_department.ID_department', $this->ID_current_department_employee);
				}
				//die();
			}
			$crud->unset_clone();
	...
	public function Show_documents($ID_department)
	{
		...
		/******************************** Session Access Control **********************************/
		$test_verif_view = 0;
		$current_function = "Show_documents";
		foreach ($this->viewarray as $row) {
			if ($row == $current_function) {
				$test_verif_view = 1;
				break;
	...
	function create_request_from_document()
	{
		...
		/******************************** Session Access Control **********************************/
		$test_verif_view = 0;
		$current_function = "create_request_from_document";
		foreach ($this->viewarray as $row) {
			if ($row == $current_function) {
				$test_verif_view = 1;
				break;
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			if ($this->employeeaccount == 1) {
				$crud->where('ID_employee', $this->ID_current_employee);
			}
			//die();
	...
	function Delete_request($ID_document)
	{
		...
		$this->load->view('Employee/Delete_request.php');
	}
	...
	function Update_request($ID_document)
	{
		...
		/******************************** Session Access Control **********************************/
		$test_verif_view = 0;
		$current_function = "Update_request";
		foreach ($this->viewarray as $row) {
			if ($row == $current_function) {
				$test_verif_view = 1;
				break;
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
			//redirect(base_url() . 'Employee/Update_request/'.$ID_document.'/add');
		}
	}
	...
	function Create_request($ID_document)
	{
		...
		/******************************** Session Access Control **********************************/
		$test_verif_view = 0;
		$current_function = "Create_request";
		foreach ($this->viewarray as $row) {
			if ($row == $current_function) {
				$test_verif_view = 1;
				break;
	...
	function List_Requests()
	{
		...
		if ($this->employeeaccount == 1) {
			...
			/******************************** Session Access Control **********************************/
			$test_verif_view = 0;
			$current_function = "List_Requests";
			foreach ($this->viewarray as $row) {
				if ($row == $current_function) {
					$test_verif_view = 1;
					break;
			...
			if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
				...
				if ($this->directoraccount == 1) {
					$crud->where('ID_department', 0);
					foreach ($this->ID_current_department_director as $row) {
						foreach ($row as $row1) {
							//echo $row1 ;
							$dept = intval($row1);
							//echo $dept; die();
							$crud->or_where('ID_department', $dept);
						}
					}
					//die();
				}
				...
				$crud->add_action('Accept', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/accept.png', 'Employee/Accept_request/', '');
				$crud->add_action('Refuse', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/refuse.png', 'Employee/Refuse_request/', '');
	...
	function Accept_request($ID_requests)
	{
		...
		redirect(base_url() . 'Employee/List_Requests');
	}
	...
	public function Document_Status()
	{
		...
		$this->load->view('Employee/Requests_status');
	}
	public function Document_Status_update()
	{
		...
		/******************************** Session Access Control **********************************/
		$test_verif_view = 0;
		$current_function = "Document_Status_update";
		foreach ($this->viewarray as $row) {
			if ($row == $current_function) {
				$test_verif_view = 1;
				break;
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			if (isset($_POST['create'])) {
				...
				$crud->add_action('Update', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Employee/Add_Document', '');
			...
			if (isset($_POST['update'])) {
				...
				$crud->where('Validatedby_requests!=' . 0);
				$crud->where('Validatedby_requests!=' . -1);
				$crud->add_action('Update', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Employee/Update_Document', '');
				$crud->set_subject('auditquality_doc_requests');
			}
			if (isset($_POST['delete'])) {
				...
				$crud->where('Validatedby_requests!=' . 0);
				$crud->where('Validatedby_requests!=' . -1);
				$crud->add_action('Update', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/edit.png', 'Employee/Deleted_Document', '');
				$crud->set_subject('auditquality_doc_requests');
			}
	...
	function Update_Document($ID_request)
	{
		...
		//die();
		$this->load->view('Employee/Update_Document', $data);
	}
	...
	function Add_Document($ID_request)
	{
		...
		$this->load->view('Employee/Add_Document', $data);
	}
	...
	function Add_Document_action($ID_request)
	{
		...
		if (($Validatedby_requests != 0) || ($Validatedby_requests != -1)) {
			return site_url('Employee/Add_Document', $data);
		} else {
			return site_url('');
		}
	}
	...
	function submit_update_doc()
	{
		...
		return redirect(base_url() . 'Employee/Document_Status');
	}
	...
	function Document_validation()
	{
		...
		if ($this->employeeaccount == 1) {
			...
			/******************************** Session Access Control **********************************/
			$test_verif_view = 0;
			$current_function = "Document_validation";
			foreach ($this->viewarray as $row) {
				if ($row == $current_function) {
					$test_verif_view = 1;
					break;
			...
			if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
				...
				$crud->add_action('Accept', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/accept.png', 'Employee/Accept_document/', '');
				$crud->add_action('Refuse', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/refuse.png', 'Employee/Refuse_document/', '');
	...
	function Accept_document($ID_version)
	{
		...
		redirect(base_url() . 'Employee/Document_validation');
	}
	...
	function Requests()
	{
		...
		if ($this->directoraccount == 1) {
			...
			$this->load->view('Employee/Requests');
		}
	}
	...
	function Intern_audit()
	{
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			//$crud->add_action('Audit Date', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Employee/Audit_date', '');
			$crud->add_action('Audit Actors', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Employee/Audit_actor', '');
			$crud->add_action('Non conformities', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Employee/Audit_non_conformities', '');
	...
	function Audit_actorlll($ID_audit)
	{
		...
		/******************************** Session Access Control **********************************/
		$test_verif_view = 0;
		$current_function = "Audit_actorlll";
		foreach ($this->viewarray as $row) {
			if ($row == $current_function) {
				$test_verif_view = 1;
				break;
	...
	function Audit_non_conformities($ID_audit)
	{
		...
		/******************************** Session Access Control **********************************/
		$test_verif_view = 0;
		$current_function = "Audit_non_conformities";
		foreach ($this->viewarray as $row) {
			if ($row == $current_function) {
				$test_verif_view = 1;
				break;
	...
	public function Posts()
	{
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			//	$crud->add_action('Add Skill', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/skill.png', 'Employee/add_Skill', '');
	...
	public function Skill_for_post($post_array)
	{
		...
		//return redirect(base_url() . 'Employee/Access/' . $ID_department);
	}
	...
	function add_Position_to_department($ID_department)
	{
		...
		/******************************** Session Access Control **********************************/
		$test_verif_view = 0;
		$current_function = "add_Position_to_department";
		foreach ($this->viewarray as $row) {
			if ($row == $current_function) {
				$test_verif_view = 1;
				break;
	...
	function department(/*$ID_company*/)
	{
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			//$crud->required_fields('Titre');
			$crud->columns('Name_department');
			$crud->add_action('Access Management', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Employee/Access', '');
			$crud->add_action('New Position', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/skill.png', 'Employee/add_Position_to_department', '');
			$crud->add_action('Employees', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/skill.png', 'Employee/Employees', '');
			$crud->add_action('Director', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/director.png', 'Employee/Director', '');
	...
	function Director($ID_department)
	{
		...
		$this->load->view('Employee/Affect_director', $data);
	}
	...
	function submit_affect_director()
	{
		if ($_POST) {
			...
			return redirect(base_url() . 'Employee/Department/');
		}
	}
	...
	function Employees($ID_department)
	{
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			$crud->add_action('Skills', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Employee/Skill_employee', '');
	...
	function Employee()
	{
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			$crud->add_action('Department & Position', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/Access.png', 'Employee/Department_position', '');
	...
	public function Department_position($ID_employee)
	{
		...
		/*if ($_POST) {
			if ($_POST['ID_department']) {
				...
				$this->load->view('Employee/Department_position', $data);
			} else {
				if ($_POST['newID_department']) {
					...
					return redirect(base_url() . 'Employee/submit_department_position/?ID_department=' . $data['newID_department'] . '&ID_post=' . $data['newID_post'] . '$ID_director=' . $data['ID_employee']);
				}
			}
		} else {
			$this->load->view('Employee/Department_position', $data);
	...
	public function Position_department()
	{
		...
		$this->load->view('Employee/Position_department', $data);
	}
	...
	function submit_department_position()
	{
		...
		return redirect(base_url() . 'Employee/Employee');
	}
	/***********************************************************************************/
	/***********************************************************************************/
	...
	public function Risk()
	{
		...
		if (($test_verif_view == 0) && ($test_verif_edit == 0)) {
			...
			$crud->set_relation('ID_department', 'auditquality_department', '{Name_department}');
			$crud->set_relation('ID_type', 'auditquality_type', '{Title_type}');
			$crud->add_action('Actions for Risk', base_url() . '/assets/grocery_crud/themes/flexigrid/css/images/form.png', 'Employee/Action_risk', '');
